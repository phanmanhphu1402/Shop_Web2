                                    ...
                                    <tbody>
                                        <?php foreach ($orders as $order) { ?>
                                            <tr>
                                                ...
                                                <td class="text-right ">
                                                    <center><?= formatCurrency($order['selling_price']) ?></center>
                                                </td>
                                                <td class="text-center "><?= $order['quantity'] ?></td>
                                                <td class="text-right ">
                                                    <center><?= formatCurrency($order['selling_price'] * $order['quantity']) ?></center>
                                                </td>
                                            </tr>
                                        <?php } ?>
                                        <tr class="order_summary">
                                            ...
                                            <td class="text-right"><b>
                                                    <center><?= formatCurrency($order_total) ?></center>
                                                </b></td>
                                        </tr>
                                        <tr class="order_summary">
                                        ...
                                        <tr class="order_summary order_total">
                                            ...
                                            <td class="text-right"><b>
                                                    <center><?= formatCurrency($order_total) ?>đ</center>
                                                </b></td>
                                        </tr>
                                    </tbody>
                                </table>
